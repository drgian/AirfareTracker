...
async def main():
    async with async_playwright() as p:
        ...
        await pg.locator(".apick", has_text="American").click()    # pick American; its cabins replace Delta's
        ...
        await pg.locator(".apick", has_text="Delta").click()       # back to Delta for the rest of the run
